...
export default async function LandingPage() {
  ...
  return <main className="landing-page">
    <header className="landing-header">
      ...
      <nav aria-label="랜딩페이지 메뉴"><a href="#benefits">서비스 소개</a><a href="#how-it-works">이용 방법</a><HardNavigationLink className="landing-header-cta" href={portal.href}>{portal.label}<span>→</span></HardNavigationLink></nav>
    </header>
    ...
    <section className="landing-hero">
      <div className="landing-hero-copy">
        ...
        <div className="landing-actions"><HardNavigationLink className="landing-primary" href={portal.href}>{profile ? portal.label : "무료로 시작하기"}<span>→</span></HardNavigationLink><a className="landing-secondary" href="#benefits">어떻게 달라지나요?</a></div>
    ...
    <section className="landing-final-cta"><div><span>NGN-X · CLASSFLOW</span><h2>강사 배정,<br />이제 연락보다 흐름으로 관리하세요.</h2><p>운영센터와 강사 모두에게 더 명확한 수업 운영을 시작합니다.</p></div><HardNavigationLink href={portal.href}>{profile ? portal.label : "클래스플로우 시작하기"}<span>→</span></HardNavigationLink></section>
